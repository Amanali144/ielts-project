    ...
    <footer id="contact" className="bg-gradient-to-r from-blue-800 to-blue-900 text-white py-16">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="mb-6 md:mb-0">
            <h2 className="text-2xl font-extrabold mb-4">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-100 to-white">IELTS Pro</span>
            </h2>
            <p className="text-blue-200 mb-4 max-w-xs">Your trusted partner for IELTS preparation and guaranteed success.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-blue-200 hover:text-white transition-colors">IELTS Tips</a></li>
              <li><a href="#" className="text-blue-200 hover:text-white transition-colors">Practice Tests</a></li>
              <li><a href="#" className="text-blue-200 hover:text-white transition-colors">Study Materials</a></li>
        ...
        <div className="border-t border-blue-700 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-blue-200">© 2025 IELTS Pro Institute. All rights reserved.</p>
